...
# SECRET_KEY = 'django-insecure-hzpych_mak6mrj!k%j4wudstkw_3s337fddp1pkd(^uya6i!&p'
...
MIDDLEWARE = [
    ...
    'accounts.middleware.VisitorMiddleware',
...
SMS_LOGIN_TEMPLATE_ID = config("SMS_LOGIN_TEMPLATE_ID")
SMS_REGISTER_TEMPLATE_ID = config("SMS_REGISTER_TEMPLATE_ID")
